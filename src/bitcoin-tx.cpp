...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s codecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  codecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded codecoin transaction") + "\n" +
              "  codecoin-tx [options] -create [commands]   " + _("Create hex-encoded codecoin transaction") + "\n" +
              "\n";
