...
const char * const BITCOIN_CONF_FILENAME = "codecoin.conf";
const char * const BITCOIN_PID_FILENAME = "codecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Codecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Codecoin";
#else
    // Unix
    return pathRet / ".codecoin";
#endif
#endif
}
