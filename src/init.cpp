...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/codecoin-project/codecoin>";
    const std::string URL_WEBSITE = "<https://codecoin.org>";
